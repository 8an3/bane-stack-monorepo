...
import { ResizableHandle, div, ResizablePanelGroup } from "~/components/ui/resizable";
...
export function Mail({}) {
	...
	const defaultCollapsed = collapsed ? false : undefined;
   ...
   */
	...
	//  defaultSize={defaultLayout[2]} minSize={30}
		...
		<TooltipProvider delayDuration={0}>
			<div class="flex flex-col h-screen">
				<div class="flex flex-1">
					<div class="w-1/3 p-4">
						<div className={cn(isCollapsed && "min-w-[50px] transition-all duration-300 ease-in-out")}>
				...
				<div class="h-2/3 bg-gray-300 p-4">
