			...
			<div className="flex-col md:flex mt-5">
				<Tabs defaultValue="Mail 01">
					...
					<TabsContent value="Mail 01">
						...
						<Mail   mails={mails} defaultLayout={defaultLayout} defaultCollapsed={defaultCollapsed} navCollapsedSize={4} />
						</div>
					</TabsContent>
...
export default function DefaultPage() {
  ...
  const [name, setName] = useState("MailPage");

  const sections = [
    { name: "MailPage", value: "MailPage", path: "/examples/email/MailPage.tsx.txt" },
    { name: "data", value: "data", path: "/examples/email/data.tsx.txt" },
    { name: "nav", value: "nav", path: "/examples/email/nav.tsx.txt" },
    { name: "mail", value: "mail", path: "/examples/email/mail.tsx.txt" },
    { name: "mail-list", value: "mail-list", path: "/examples/email/mail-list.tsx.txt" },
    { name: "mail-display", value: "mail-display", path: "/examples/email/mail-display.tsx.txt" },
    { name: "account-switcher", value: "account-switcher", path: "/examples/email/account-switcher.tsx.txt" },
  ...
  switch (name) {
    case "MailPage":
      ...
      break;
        case "nav":
      viewSelected = <Scaffolding title="nav" />;
      break; 
       case "mail":
      viewSelected = <Scaffolding title="mail" />;
      break; 
       case "mail-list":
      viewSelected = <Scaffolding title="mail-list" />;
      break; 
       case "mail-display":
      viewSelected = <Scaffolding title="mail-display" />;
      break;
        case "account-switcher":
      viewSelected = <Scaffolding title="account-switcher" />;
      break;
  }
  useEffect(() => {
